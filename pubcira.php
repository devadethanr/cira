...
//   complaint registration query
  if(isset($_POST['btn_co_reg'])){
	...
	$comp_reg_query="INSERT INTO `complaints`( `pub_id`,  `pol_id` ,`cm_categ`, `cm_sub`, `cm_against`, `cm_desc`, `cm_status`, `cm_date`)
				 VALUES ('$master','".$USER_ROW['pub_station']."','".$_POST['comp_categ']."','".$_POST['comp_sub']."','".$_POST['comp_against']."','".$_POST['comp_desc']."','1','".$_POST['comp_date']."')";
...
s
							        <li class="nav-item dropdown mega-dropdown">
							        	<button class="nav-link" aria-expanded="false" data-bs-toggle="modal" data-bs-target="#fine_pmt"> <i class="fa-regular fa-credit-card fa-bounce"></i> Fines and Penalties</button>
						            </li>
							        <li class="nav-item dropdown mega-dropdown">
                    ...
                    <div class="modal-body">
                    	...
                    	<form enctype="multipart/form-data" method="POST" id="contact_form">
							...
							<div class="comp_date">  
								...
								<input type="date" placeholder="Date of Occurance" name="comp_date" id="comp_date" required>
							</div>
				...
				<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
					...
					<div class="modal-body">
						...
						<table class="table" >
							...
							<tbody>
								<?php 
									$cm_ls_qu= "SELECT * FROM `complaints`";
								...
								<tr>
									...
									<td scope="col"><?php 
										...
										elseif($cm_row['cm_status']==4){
											echo "<span class='label label-danger'>discarded/completed</span>" ;
										}
									?></td>
								</tr>
								<?php
				...
				<div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
					<div class="modal-content">
						...
						<div class="modal-body text-center mb-1">
							...
							<h5 class="mt-1 mb-2"><?php echo $USER_ROW['f_name']; echo $USER_ROW['f_name'];?></h5>
			...
			<div class="hero-banner-five text-center position-relative">
				<div class="container">
					...
					<a href="contact-us.html" class="donate-btn fw-500 tran3s wow fadeInUp" data-wow-delay="0.4s">file a complaint</a>
				</div> <!-- /.container -->
			...
			============================================== 
			-->
			<div class="fancy-feature-fifteen position-relative mt-140 lg-mt-70">
				<img src="images/lazy.svg" data-src="images/shape/shape_76.svg" alt="" class="lazy-img shapes shape-one">
				<div class="container">
					<div class="row">
						<div class="col-lg-5 col-md-10 wow fadeInLeft">
							<div class="title-style-six pe-xxl-5">
								<h2 class="main-title fw-500 tx-dark">Help us to end poverty for good start with a child.</h2>
							</div> <!-- /.title-style-six -->
						</div>
						<div class="col-lg-6 ms-auto wow fadeInRight">
							<p class="m0 sp-text1 fs-20 pb-85 lg-pb-30 md-pt-20">Growing up in poverty, children face tough challenges: hunger and malnutrition, limited access to education and medical services, social discrimination and isolation. we can end poverty for good.</p>
							<div class="d-sm-flex align-items-center">
								<a href="#" class="btn-nine fw-500 mt-10 me-3 lg-me-5">Sponsor a child</a>
								<a href="#" class="tran3s fw-500 tx-dark fs-16 mt-10">See how it works</a>
							</div>
						</div>
					</div>
					<div class="video-banner position-relative mt-170 mb-35 lg-mt-70 md-mb-20">
						<img src="images/lazy.svg" data-src="images/media/img_29.png" alt="" class="lazy-img">
						<a class="fancybox video-icon tran3s rounded-circle d-flex align-items-center justify-content-center" data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0">
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-two position-relative text-center mt-110 wow fadeInUp">
								<div class="main-count fw-500 tx-dark"><span class="counter">21</span>million</div>
								<p class="tx-dark fs-18 m0">People joined</p>
								<img src="images/lazy.svg" data-src="images/shape/shape_72.svg" alt="" class="lazy-img position-absolute bg-img">
							</div> <!-- /.counter-block-two -->
						</div>
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-two position-relative text-center mt-110 wow fadeInUp" data-wow-delay="0.2s">
								<div class="main-count fw-500 tx-dark"><span class="counter">28</span></div>
								<p class="tx-dark fs-18 m0">states Impected</p>
								<img src="images/lazy.svg" data-src="images/shape/shape_73.svg" alt="" class="lazy-img position-absolute bg-img">
							</div> <!-- /.counter-block-two -->
						</div>
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-two position-relative text-center mt-110 wow fadeInUp" data-wow-delay="0.3s">
								<div class="main-count fw-500 tx-dark"><span class="counter">30</span>k+</div>
								<p class="tx-dark fs-18 m0">Volunteer</p>
								<img src="images/lazy.svg" data-src="images/shape/shape_74.svg" alt="" class="lazy-img position-absolute bg-img">
							</div> <!-- /.counter-block-two -->
						</div>
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-two position-relative text-center mt-110 wow fadeInUp" data-wow-delay="0.4s">
								<div class="main-count fw-500 tx-dark"><span class="counter">2000</span></div>
								<p class="tx-dark fs-18 m0">crimes reported daily</p>
								<img src="images/lazy.svg" data-src="images/shape/shape_75.svg" alt="" class="lazy-img position-absolute bg-img">
							</div> <!-- /.counter-block-two -->
						</div>
					</div>
				</div> <!-- /.container -->
			...
			============================================== 
			-->
			<div class="fancy-feature-sixteen position-relative pt-120 pb-80 mt-225 mb-150 lg-mt-130 lg-pt-80 lg-pb-50 lg-mb-100">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 m-auto">
							<div class="title-style-six text-center wow fadeInUp">
								<div class="sc-title" style="color:#FF8A8A;">Featured Causes</div>
								<h2 class="main-title fw-500 tx-dark">You can help lots of people by donating little.</h2>
							</div> <!-- /.title-style-six -->
						</div>
					</div>
				</div>
				<div class="container">
					<div class="d-md-flex align-items-center justify-content-between text-center text-md-start mt-100 md-mt-50">
						<div>
							<div class="ins-title">See all Campaign</div>
							<h3 class="tx-dark">Click the button see all causes</h3>
						</div>
						<a href="#" class="btn-one fw-500 sm-mt-20">See all campaign</a>
					</div>
				</div>	
			...
			<div class="fancy-feature-seventeen position-relative">
				<img src="images/lazy.svg" data-src="images/shape/shape_80.svg" alt="" class="lazy-img shapes shape-four">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-xl-5 col-lg-6 ms-auto order-lg-last wow fadeInRight">
							<div class="title-style-six">
								<div class="sc-title" style="color:#4BCEB0;">How can you help?</div>
								<h2 class="main-title fw-500 tx-dark">That’s how it works is very simple.</h2>
							</div> <!-- /.title-style-six -->
							<p class="fs-20 lh-lg pe-xxl-5 mt-60 lg-mt-30">Growing up in poverty, children face tough challenges: hunger and malnutrition, limited access to education and medical services, social discrimination and isolation. we can end poverty for the good.</p>
						</div>
						<div class="col-lg-6 order-lg-first wow fadeInLeft">
							<div class="img-meta d-inline-block position-relative">
								<img src="images/lazy.svg" data-src="images/media/img_34.png" alt="" class="lazy-img">
								<img src="images/lazy.svg" data-src="images/shape/shape_77.svg" alt="" class="lazy-img shapes shape-one">
								<img src="images/lazy.svg" data-src="images/shape/shape_78.svg" alt="" class="lazy-img shapes shape-two">
								<div class="shape-three position-absolute">
									<img src="images/lazy.svg" data-src="images/shape/shape_79.svg" alt="" class="lazy-img">
									<div class="text text-center">
										<div class="fw-bold text-white sp-text1">1.2b+</div>
										<div class="text-white fs-16">Child Need <br>Food</div>
									</div>
								</div> <!-- /.shape-three -->
							</div> <!-- /.img-meta -->
						</div>
			...
			<div class="fancy-feature-eighteen wow fadeInUp mt-160 lg-mt-100">
				<div class="d-sm-flex">
					<div class="card-style-nine position-relative d-flex flex-column justify-content-center align-items-center" style="background-image:url(images/media/img_35.jpg);">
						...
						<div class="title text-white mt-25 mb-30">Make Donation</div>
					...
					<div class="card-style-nine center-item position-relative d-flex flex-column justify-content-center align-items-center" style="background-image:url(images/media/img_36.jpg);">
						...
						<div class="title tx-dark mt-25 mb-15">Be a Volunteer</div>
						<p class="fs-18 text-center tx-dark">Growing up in poverty, children face tough <br> hunge and malnutrition</p>
					</div> <!-- /.card-style-nine -->
					<div class="card-style-nine position-relative d-flex flex-column justify-content-center align-items-center" style="background-image:url(images/media/img_37.jpg);">
						...
						<div class="title text-white mt-25 mb-30">Fundrising</div>
						<a href="#" class="btn-more rounded-circle text-center fw-light tran3s">+</a>
					</div> <!-- /.card-style-nine -->
				</div>
			...
			=====================================================
			-->
			<div class="blog-section-two mt-170 lg-mt-100">
				<div class="container">
					<div class="title-style-six text-center wow fadeInUp mb-50 lg-mb-10">
						<div class="sc-title" style="color:#FF8A8A;">Our News</div>
						<h2 class="main-title fw-500 tx-dark">Our latest News</h2>
					</div> <!-- /.title-style-six -->

					<div class="row">
						<div class="col-lg-4 col-md-6">
							<article class="blog-meta-two mt-30 wow fadeInUp">
								<a href="blog-details.html" class="tag fw-bold text-uppercase" style="background:#FFEAC9;">Education</a>
								<a href="blog-details.html" class="blog-title mt-15 mb-10"><h4 class="tran3s">Internet advertising what Went wrong.</h4></a>
								<p class="fs-17 mb-35">Having a home based business is a wonderful asset to your...</p>
								<a href="blog-details.html" class="btn-ten fs-16 fw-500 position-relative">Read More <i class="fa-solid fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-two -->
						</div>
						<div class="col-lg-4 col-md-6">
							<article class="blog-meta-two mt-30 wow fadeInUp" data-wow-delay="0.2s">
								<a href="blog-details.html" class="tag fw-bold text-uppercase" style="background:#C9F0FF;">Charity</a>
								<a href="blog-details.html" class="blog-title mt-15 mb-10"><h4 class="tran3s">Internet advertising what Went wrong.</h4></a>
								<p class="fs-17 mb-35">Having a home based business is a wonderful asset to your...</p>
								<a href="blog-details.html" class="btn-ten fs-16 fw-500 position-relative">Read More <i class="fa-solid fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-two -->
						...
						<div class="col-lg-4 col-md-6">
							<article class="blog-meta-two mt-30 wow fadeInUp" data-wow-delay="0.3s">
								<a href="blog-details.html" class="tag fw-bold text-uppercase" style="background:#FFEAEA;">CHildren</a>
								<a href="blog-details.html" class="blog-title mt-15 mb-10"><h4 class="tran3s">Internet advertising what Went wrong.</h4></a>
								<p class="fs-17 mb-35">Having a home based business is a wonderful asset to your...</p>
								<a href="blog-details.html" class="btn-ten fs-16 fw-500 position-relative">Read More <i class="fa-solid fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-two -->
